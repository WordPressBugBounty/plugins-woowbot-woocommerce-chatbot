                    ...
                    switch ( $status['status'] ) {
                            ...
                            if ( $status['url'] ) {
                                if ( $compatible_php && $compatible_wp ) {
                                    $action_links[] = sprintf(
                                        ...
                                        esc_attr( $name ),
                                        __( 'Install Now', 'woowbot-woocommerce-chatbot' )
                                    );
                                } else {
                                    $action_links[] = sprintf(
                            ...
                            if ( $status['url'] ) {
                                if ( $compatible_php && $compatible_wp ) {
                                    $action_links[] = sprintf(
                                        ...
                                        esc_attr( $name ),
                                        __( 'Update Now', 'woowbot-woocommerce-chatbot' )
                                    );
                                } else {
                                    $action_links[] = sprintf(
                                        '<button type="button" class="button button-disabled" disabled="disabled">%s</button>',
                        ...
                        case 'newer_installed':
                            if ( is_plugin_active( $status['file'] ) ) {
                                ...
                                $button_text = __( 'Activate', 'woowbot-woocommerce-chatbot' );
                                ...
                                if ( is_network_admin() ) {
                                    $button_text = __( 'Network Activate', 'woowbot-woocommerce-chatbot' );
                                    /* translators: %s: Plugin name. */
