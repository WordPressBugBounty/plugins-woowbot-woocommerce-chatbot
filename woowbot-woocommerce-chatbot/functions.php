...
if(!function_exists('woo_chatbot_load_footer_html')){
            ...
            <div id="woo-chatbot-ball-wrapper" style="display:none">
                ...
                <div id="woo-chatbot-ball-container" style="display:none" class="woo-chatbot-ball-container">
                    ...
                    <h3> <?php if(get_option('qlcd_woo_chatbot_agent')!=''){echo esc_attr( get_option('qlcd_woo_chatbot_agent') );} ?></h3>
                        <button type="button" id="woo-chatbot-header-close" aria-label="<?php esc_attr_e('Close chat window', 'woowbot-woocommerce-chatbot'); ?>">&times;</button>
                    </div>
                    ...
                    <div id="woo-chatbot-editor-container" class="woo-chatbot-editor-container">
                        ...
                        <button type="button" id="woo-chatbot-send-message" class="woo-chatbot-button"><span class="dashicons dashicons-arrow-up-alt"></span></button>
                    </div>
                </div>
                <!--woo-chatbot-ball-container-->
...
if(!function_exists('qcld_woo_chatbot_keyword')){
...
if(!function_exists('qcld_woo_chatbot_category')){
...
if(!function_exists('woo_chatbot_load_controlling')){
...
if(!function_exists('qc_fnc_get_ip_address')){
...
if(!function_exists('qcld_woo_chatbot_email')){
...
// 1. Attach your custom function to a WooCommerce hook
if(get_option('enable_product_details_from_ai') == 1){
    add_action( 'woocommerce_after_add_to_cart_button', 'qcld_woo_custom_product_details', 10 );
}
