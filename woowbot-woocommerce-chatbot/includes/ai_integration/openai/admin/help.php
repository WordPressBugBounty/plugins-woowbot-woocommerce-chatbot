<div class="accordion" id="qcldopenaiaccordion">
    <div class="qcld-wocard">
        ...
        <b> 
                       <?php esc_attr_e( '**','chatbot');?><a href="https://woowbot.pro/docs/knowledgebase/how-wpbot-chatbot-free-users-can-get-customized-results-from-the-chatbot-how-to-train-the-chatbot/#customize" class="qcls_openAI_customized_link" target="_blank">
        ...
        <p>
       <b> <a href="https://www.woowbot.pro/pricing/" target="_blank"><?php esc_html_e( 'Upgrade to WoowbotPro Professional or the Master License to use GPT Assistant.','chatbot');?></a></b></p>
        </div>
        </div>
    </div>
    <div class="qcld-wocard">
    ...
    <div class="qcld-wocard">
        ...
        <a href="https://woowbot.pro/myfile.jsonl" download><?php esc_html_e( 'Right click and Save the Example jsonl file for Fine Tuning with GPT 3.5/4','chatbot');?></a></br>
        </div>
        </div>
    </div>
    		<div class="qcld-wocard">
			...
			<ul>
				<li>
					<ol>
						...
						<li><?php esc_html_e( 'Click “Embed All Selected Sources” button, after selecting the sources from the', 'wpchatbot' ); ?> <a href="<?php echo admin_url('admin.php?page=chatbot_ai_setting#ai-knowledge-base-tab'); ?>" target="_blank">knowledgebase tab</a></li>
