               <div class="card-body p-sm-0">
                    ...
                    <ul class="nav nav-tabs">
                        <li><a  class="active" data-toggle="tab" href="#wp-chatbot-gemini-settings"><i class="dashicons dashicons-admin-home"></i><?php echo esc_html__('Gemini settings', 'chatbot'); ?></a></li>
                        ...
                        <div id="wp-chatbot-gemini-rag" class="tab-pane">
                            <div class="col-sm-12">
                                <div class="wrap">
                                    ...
                                    <p>If you enable RAG, you must configure the <a id="ai-knowledge-base-tab-gemini" href="<?php echo admin_url('admin.php?page=chatbot_ai_setting#ai-knowledge-base-tab'); ?>">Knowledgebase</a> for Post types and other data to embed. </p><span style="color:red"><?php esc_html_e('It requires a paid Gemini API plan', 'chatbot'); ?> </span>
                                    <div class="form-check form-switch my-4">
                            ...
                            <div class="alert alert-info mt-20" role="alert">
                                        ...
                                        <ol>
                                            ...
                                            <li><?php echo esc_html__( 'Click “Embed All Selected Sources” button, after selecting the sources from the', 'wpchatbot' ); ?> <a href="<?php echo admin_url('admin.php?page=chatbot_ai_setting#ai-knowledge-base-tab'); ?>" target="_blank">knowledgebase tab</a></li>
                                ...
                                <div class="wp-chatbot-gemini-help">
                                    ...
                                    <div id="panelsStayOpen-collapseZero-gemini" class="collapse" aria-labelledby="panelsStayOpen-headingZero-gemini" data-parent="#qcldopenaiaccordion">
                                        <div class="card-body-gemini">
                                            <p><?php esc_html_e( 'Gemini is an unified Interface or Aggregator for LLMs. You can choose from hundreds of different AI models from OpenAI to Deepseek or Claude to get AI responses.','chatbot');?></p>
                                            <p><?php esc_html_e( 'All you have to do is add the Gemini API Key and select an Gemini Model.','chatbot');?></p>
                                            <p><?php esc_html_e( 'Grab your API key from','chatbot');?> <a href="https://gemini.ai/settings/keys">HERE</a></p>
