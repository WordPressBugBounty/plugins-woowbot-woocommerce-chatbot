        ...
        <div class="wrap">
            ...
            <div id="post-body-content">
                ...
                <div style="padding: 15px 10px; text-align: center; margin-top: 20px;margin-left: 0;color: #000;background: #fff;width:100%;     border-radius: 16px;">
                    <?php esc_html_e('Crafted By:', 'woowbot-woocommerce-chatbot'); ?> <a href="<?php echo esc_url('http://www.quantumcloud.net'); ?>" target="_blank"><?php esc_html_e('Web Design Company', 'woowbot-woocommerce-chatbot'); ?></a> -
